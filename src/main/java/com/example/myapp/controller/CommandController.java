...
public class CommandController {
	...
	@GetMapping("/init")
	public List<String> serviceInit() {
		service.init();
	...
	public List<String> setDifficulty(@RequestBody String difficulty) {
		...
		} else if (difficulty.equals("twins")) {
			service.goFirstFloor(7);
		} else if (difficulty.equals("roulette")) {
			service.goFirstFloor(8);
		} else if (difficulty.equals("fushigi")) {
			service.goFirstFloor(9);
		} else {
			service.debugInit();
		}
		return service.makeList();
	...
	@GetMapping("/itemRightSwitch")
	public List<String> itemRightSwitch() {
		service.rightSwitchItem();
		return service.makeList();
	}

	@GetMapping("/itemLeftSwitch")
	public List<String> itemSwitch() {
		service.leftSwitchItem();
		return service.makeList();
	}

	@PostMapping("/target")
	public List<String> targetMonster(@RequestBody String i) {
		return service.targetMonster(Integer.parseInt(i));
	}
