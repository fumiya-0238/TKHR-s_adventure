...
public class InfoController {
	...
	public Map<String, List<String>> conditionConfirm() {
		return service.makeConditionConfirm();
	}
	...
	@PostMapping("/monsterInfo")
	public List<String> getMonsterInfo(@RequestBody String index) {
		return service.makeBattleMonsterInfo(Integer.parseInt(index));
	}

	@PostMapping("/subPageInfo")
	public List<String> getRelationInfo(@RequestBody Map<String, Object> request) {
		return service.makeSubPageInfo((int) request.get("index"), (int) request.get("selectedIndex"));
	}
