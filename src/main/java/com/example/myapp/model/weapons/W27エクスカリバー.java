...
public class W27エクスカリバー extends Weapon {
	private void exGet(Battle battle) {
		battle.getPlayer().addItem(CreateItem.INSTANCE.create(3));
		battle.getPlayer().addItem(CreateItem.INSTANCE.create(5));
		battle.getPlayer().addItem(CreateItem.INSTANCE.create(7));
	}
