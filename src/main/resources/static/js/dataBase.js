...
fetch('/getDataBase').then(response => response.json())
	.then(data => {
		...
		createDungeonMonsterTable(data['beginnerMonster'], document.querySelector(
			'#beginnerMonsterDataBase table'));
		createDungeonMonsterTable(data['noviceMonster'], document.querySelector(
			'#noviceMonsterDataBase table'));
		createDungeonMonsterTable(data['expertMonster'], document.querySelector(
			'#expertMonsterDataBase table'));
		createShopItemTable(data['beginnerItem'], document.querySelector(
			'#beginnerItemDataBase table'));
		createShopItemTable(data['noviceItem'], document.querySelector(
			'#noviceItemDataBase table'));
		createShopItemTable(data['expertItem'], document.querySelector(
			'#expertItemDataBase table'));
		createShopWeaponTable(data['beginnerWeapon'], document.querySelector(
			'#beginnerWeaponDataBase table'));
		createShopWeaponTable(data['noviceWeapon'], document.querySelector(
			'#noviceWeaponDataBase table'));
		createShopWeaponTable(data['expertWeapon'], document.querySelector(
			'#expertWeaponDataBase table'));
		createShopServiceTable(data['beginnerService'], document.querySelector(
			'#beginnerServiceDataBase table'));
		createShopServiceTable(data['noviceService'], document.querySelector(
			'#noviceServiceDataBase table'));
		createShopServiceTable(data['expertService'], document.querySelector(
			'#expertServiceDataBase table'));
		createDungeonMonsterTable(data['shortageMonster'], document.querySelector(
			'#shortageMonsterDataBase table'));
		createShopFloorTable(data['beginnerShopFloor'], document.querySelector(
			'#beginnerShopFloorDataBase table'));
		createShopFloorTable(data['noviceShopFloor'], document.querySelector(
			'#noviceShopFloorDataBase table'));	
		createShopFloorTable(data['expertShopFloor'], document.querySelector(
			'#expertShopFloorDataBase table'));
		createShopFloorTable(data['shortageShopFloor'], document.querySelector(
			'#shortageShopFloorDataBase table'));
		createShopItemTable(data['shortageItem'], document.querySelector(
			'#shortageItemDataBase table'));
		createShopWeaponTable(data['shortageWeapon'], document.querySelector(
			'#shortageWeaponDataBase table'));
		createShopServiceTable(data['shortageService'], document.querySelector(
			'#shortageServiceDataBase table'));
	})
...
function createDungeonMonsterTable(data, table) {
	const tbody = document.createElement('tbody');
	for (let i = 0, l = parseInt(data.length); i < l; i++) {
		const tr = document.createElement('tr');
		tr.className = 'dataBaseRow';
...
function createShopFloorTable(data, table) {
	const tbody = document.createElement('tbody');
	for (let i = 0, l = parseInt(data.length); i < l; i++) {
		const tr = document.createElement('tr');
		tr.className = 'dataBaseRow';
...
function createShopItemTable(data, table) {
	const tbody = document.createElement('tbody');
	for (let i = 0, l = parseInt(data.length); i < l; i++) {
		const tr = document.createElement('tr');
		tr.className = 'dataBaseRow';
...
function createShopWeaponTable(data, table) {
	const tbody = document.createElement('tbody');
	for (let i = 0, l = parseInt(data.length); i < l; i++) {
		const tr = document.createElement('tr');
		tr.className = 'dataBaseRow';
...
function createShopServiceTable(data, table) {
	const tbody = document.createElement('tbody');
	for (let i = 0, l = parseInt(data.length); i < l; i++) {
		const tr = document.createElement('tr');
		tr.className = 'dataBaseRow';
...
addButton.addEventListener('click', () => {
	...
	const table = elements[activeIndex];
